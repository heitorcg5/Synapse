export function GraphStats({
  ...
  return (
    <div className="absolute bottom-4 left-4 z-10 rounded-xl border border-white/10 bg-[#0f1422]/80 px-3 py-2 text-xs text-slate-300 shadow-xl backdrop-blur-sm">
